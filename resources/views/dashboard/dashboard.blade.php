                                ...
                                <div>
                                    ...
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium"><sup
                                                class="set-doller"></sup>@currency($data_saldo)</h2>
                                        <span
                                ...
                                <div>
                                    ...
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium" style="margin-top:40px !important">
                                            ...
                                            @currency($hasilpemasukan)
                                        </h2>
                                        <span
                                            class="badge bg-primary font-12 text-white font-weight-medium badge-pill ml-2 d-md-none d-lg-block" style="margin-top:40px !important">{{ $pemasukan_persen }}%</span>
                                    </div>
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">
                                        {{ $pemasukan }} % dari bulan lalu
                                    </h6>
                                </div>
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium" style="margin-top:40px !important">
                                            {{-- <sup class="set-doller"></sup> --}}
                                            @currency($hasilpengeluaran)
                                        </h2>
                                        <span
                                            class="badge bg-danger font-12 text-white font-weight-medium badge-pill ml-2 d-md-none d-lg-block" style="margin-top:40px !important">{{ $pengeluaran_persen }}%</span>
                                    </div>
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">
