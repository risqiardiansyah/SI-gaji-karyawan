...
<body class="clean-body u_body"
    style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;color: #000000; background-image: url({{ public_path('storage/certificate-alan.jpg') }}); background-size: cover; background-repeat: no-repeat; margin: 0 !important; padding: 0 !important;">
                                ...
                                <div class="u-col u-col-100"
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <table
                                                style="font-family:'Open-sans',sans-serif; margin-top: 30%; margin-left: -235%; padding-left: 0;"
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0px;font-family:'Open-sans',sans-serif;"
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                border="0" style="margin-right: 10%;">
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px; text-align: left; font-weight: 400;"
                                                                        align="left">
                                                                        <h3 style="font-weight: 400; margin-bottom: 0;">
                                                                            Diberikan
                                                                            Kepada : </h3>
                                                                        <div>
                                                                            <h1>{{ $data->karyawan_nama }}</h1>
                                                                            <h4
                                                                                style="margin-bottom: 5px; margin-top: 0 !important">
                                                                                MAHASISWA
                                                                                {{ strtoupper($data->asal_kampus) }}
                                                                            </h4>
                                                                        </div>
                                                                        <h4 style="font-weight: 400; max-width: 500px;">
                                                                            Telah melaksanakan program magang di
                                                                            Alan Creative sebagai {{ $data->posisi }}
                                                                            selama
                                                                            {{ $data->lama_magang }} bulan, mulai dari
                                                                            {{ \Carbon\Carbon::parse($data->dari_bulan)->locale('id')->isoformat('DD MMMM Y') }}
                                                                            sampai dengan
                                                                            {{ \Carbon\Carbon::parse($data->sampai_bulan)->locale('id')->isoformat('DD MMMM Y') }}
                                                                            dengan hasil BAIK.
                                                                        </h4>
                                                                        <h4 style="font-weight: 400; margin-top: 30px;">
                                                                            Depok,
                                                                            {{ \Carbon\Carbon::now()->locale('id')->isoformat('DD MMMM Y') }}
                                                                        </h4>
                                                                        <p
                                                                            style="color: #1aaf6d; margin-top: 0px; margin-bottom: 5px;">
