            ...
            <div class="container">
                ...
                <div class="card overflow-hidden">
                    <div class="card-body border-bottom  shadow-sm p-3 bg-white rounded">
                        ...
                        <div class="row p-3">
                            <div class="col-md-4">
                                <a class="btn tombol btn-primary" style="width:50%" href="{{route('quotationcreate')}}"
                    ...
                    <div class="container bg-white p-3 mb-5" style="height: 100%;">
                        ...
                        <div class="table-responsive mt-4 mb-5 ">
                            ...
                            <table class="table  table-bordered table-sm" id="coba">
                                ...
                                <?php $i = 0; ?>
                                @foreach($quotation as $datas)
                                <tbody>
                                    <tr class="table-primary">
                                        <th scope="row" class="text-center ">{{ ++$i }}</i></th>
                                        <td class="text-center">{{ $datas->perihal}}</td>
                                        <td class="text-center">{{ \Carbon\Carbon::parse($datas->tgl_quotation)->locale('id')->isoformat('DD MMMM Y') }}</td>
                                        <td class="text-center">{{ \Carbon\Carbon::parse($datas->tgl_jatuh_tempo)->locale('id')->isoformat('DD MMMM Y') }}</td>
                                        <td class="text-center">{{ $datas->jumlah_pembayaran}}</td>
                                        <td class="text-center">

                                            <a href="{{url('/quotation/'. $datas->id_quotation. '/edit')}}"
                                                class="ml-auto mr-1"><img src="img/edit.png"></a>
                                            <a href="{{url('/quotation/'.$datas->id_quotation. '/delete/' )}}"
                                                class="mr-auto ml-1"><img src="img/delete-button.png"></a>
                                            <a href="{{url('/quotation/'.$datas->id_quotation. '/print/' )}}"
