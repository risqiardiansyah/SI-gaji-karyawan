    ...
    <div class="container">
        @if ($data->letter_peruntukan == '1')
            ...
            <div class="content-isi mt-3">
                ...
                <p class="text-justify">Sehubungan dengan surat lamaran kerja yang Anda kirimkan ke perusahaan kami
                    beberapa waktu
                ...
                <div class="ml-4 mt-1">
                    <div class="row ">
                        ...
                        <div class="columnvalue"> :
                            {{ \Carbon\Carbon::parse($data->letter_tanggal_mulai)->locale('id')->isoFormat('dddd, D MMMM Y') }}
                        </div>
                    </div>
                    <div class="row ">
                    ...
                    <div class="row ">
                        ...
                        <div class="columnvalue">: {{ $data->letter_telepon_pembimbing }} (
                            {{ $data->letter_narahubung }} )
                        </div>
                    </div>
                </div>
                <div class="mt-3">
                    <div class="row ">
                        <p class="text-justify">Kami harapkan kedatangan saudari di tempat dan waktu yang telah
                            ditetapkan
                            tersebut. Apabila ada kendala perihal kehadiran, mohon dapat menginformasikan hal tersebut
                            kepada
                            kami.</p>
                    </div>
                    <div class="row " style="margin-top:-30px">
                        <p class="text-justify"> Demikian yang dapat kami sampaikan. Atas perhatian dan kerjasamanya
                            kami ucapkan
                            terima
                            kasih.</p>
                    </div>
...
<div class="container">
    ...
    <div class="content-isi ">
        <div class="row">
            <p class="text-justify">Berdasarkan lamaran internship anda pada tanggal
                {{ \Carbon\Carbon::parse($data->letter_tanggal_lamaran)->locale('id')->isoFormat(' D MMMM Y') }}
                melalui
    ...
    <div class="ml-4 mt-2">
        ...
        <div class="row ml-3">
            ...
            <div class="columnvalue">:
                {{ \Carbon\Carbon::parse($data->letter_tanggal_selesai)->locale('id')->isoFormat('dddd, D MMMM Y') }}
            </div>
        </div>
        <div class="row ml-3">
    ...
    <div class="mt-2">
        <div class="row ">
            <p class="text-justify mt-3">Demikian informasi penerimaan internship ini kami sampaikan, jika ada yang
                ingin
                ditanyakan dapat
